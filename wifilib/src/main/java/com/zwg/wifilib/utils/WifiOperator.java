...
public class WifiOperator {
     ...
     */
    public void addNetWorkAndConnect(String ssid, String password, com.zwg.wifilib.dialog.WifiOperator.WifiCipherType wifiCipherType) {
    ...
    private WifiConfiguration createWifiConfiguration(String ssid, String password, com.zwg.wifilib.dialog.WifiOperator.WifiCipherType type) {
